...
<input type="hidden" id="page_url" value="<?php echo e(route('package.index')); ?>">
								...
								<tr id="id-<?php echo e($model->slug); ?>">
									...
									<td>
										...
										<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('package-delete')): ?>
                                            <button class="btn btn-danger btn-xs delete" data-slug="<?php echo e($model->slug); ?>" data-del-url="<?php echo e(url('package', $model->slug)); ?>"><i class="fa fa-trash"></i> Delete</button>
										<?php endif; ?>
									</td>
								</tr>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mockmyinterview\resources\views/admin/package/index.blade.php ENDPATH**/ ?>
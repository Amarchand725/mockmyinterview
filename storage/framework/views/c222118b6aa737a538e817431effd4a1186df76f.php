                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-6 pt-4 pt-lg-0 content">
                            <?php echo $home_page_data['about_left_content']; ?>

                        </div>
                        <div class="col-lg-6 pt-4 pt-lg-0 content">
                            <?php echo $home_page_data['right_left_content']; ?>
            ...
            <section id="cta" class="cta">
                <div class="container">
                    <div class="text-center">
                        ...
                        <a class="cta-btn" href="<?php echo e(route('signup')); ?>"><?php echo e($home_page_data['home_signup_btn_label']); ?></a>
                    </div>
                </div>
            </section>
        <?php endif; ?>
                                ...
                                <div class="pricing-item" style="box-shadow: 0px 0px 30px -7px rgba(0,0,0,0.29);">
                                    ...
                                    <div class="pricing-price pb-1 ">
                                        <h1 style="font-weight: 1000; font-size: 3.5em;">
                                            <span style="font-size: 20px;"><?php echo e($home_page_data['header_currency_symbol']); ?></span><?php echo e($package->price); ?>

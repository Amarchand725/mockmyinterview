				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="footer_title" class="form-control" value="<?php echo e(isset($page_data['footer_title'])?$page_data['footer_title']:''); ?>" placeholder="Enter title">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Sub Title</label>
							<div class="col-sm-9">
								<textarea name="footer_sub_title" id="" class="form-control" placeholder="Enter description"><?php echo e(isset($page_data['footer_sub_title'])?$page_data['footer_sub_title']:''); ?></textarea>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="footer_copy_right" class="form-control" value="<?php echo e(isset($page_data['footer_copy_right'])?$page_data['footer_copy_right']:''); ?>" placeholder="Enter copy rights">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Phone </label>
							<div class="col-sm-9">
								<input type="text" name="footer_phone" class="form-control" value="<?php echo e(isset($page_data['footer_phone'])?$page_data['footer_phone']:''); ?>" placeholder="Enter phone no">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="footer_skype" class="form-control" value="<?php echo e(isset($page_data['footer_skype'])?$page_data['footer_skype']:''); ?>" placeholder="Enter social link">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea name="footer_address" id="" class="form-control" placeholder="Enter address"><?php echo e(isset($page_data['footer_address'])?$page_data['footer_address']:''); ?></textarea>
							</div>
						</div>
						<div class="form-group">
						...
						<?php if(isset($page_data['footer_app_image'])): ?>
							<div class="form-group">
								<label for="" class="col-sm-2 control-label">Existing Image</label>
								<div class="col-sm-9" style="padding-top:6px;">
									<img src="<?php echo e(asset('/public/admin/assets/images/page/'.$page_data['footer_app_image'])); ?>" class="existing-photo" style="height:50px;">
								</div>
							</div>
						<?php endif; ?>
						<div class="form-group">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mockmyinterview\resources\views/admin/page_setting/footer.blade.php ENDPATH**/ ?>
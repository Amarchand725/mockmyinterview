<aside class="main-sidebar">
    <section class="sidebar">
        <ul class="sidebar-menu">
            ...
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('referral-list')): ?>
            <li class="treeview">
                <a href="<?php echo e(route('referral.index')); ?>" class="<?php echo e(request()->is('referral') || request()->is('referral/*')? 'active' : ''); ?>">
            ...
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('interview_type-list')): ?>
            <li class="treeview">
                <a href="<?php echo e(route('interview_type.index')); ?>" class="<?php echo e(request()->is('interview_type') || request()->is('interview_type/*')? 'active' : ''); ?>">

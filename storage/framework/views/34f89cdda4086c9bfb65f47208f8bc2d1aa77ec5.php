        ...
        $('.delete-btn').on('click', function(){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url : "<?php echo e(url('advantage')); ?>/"+model_slug,
						type : 'DELETE',
                        data: {
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mockmyinterview\resources\views/admin/advantage/index.blade.php ENDPATH**/ ?>
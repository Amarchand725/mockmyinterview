...
<input type="hidden" id="page_url" value="<?php echo e(route('help.index')); ?>">
								...
								<tr id="id-<?php echo e($model->slug); ?>">
									...
									<td>
										...
										<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('help-delete')): ?>
                                            <button class="btn btn-danger btn-xs delete" data-slug="<?php echo e($model->slug); ?>" data-del-url="<?php echo e(url('help', $model->slug)); ?>"><i class="fa fa-trash"></i> Delete</button>
										<?php endif; ?>
									</td>
								</tr>

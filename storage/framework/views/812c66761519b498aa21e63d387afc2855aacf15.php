                ...
                <div class="col-md-6">
                    <div class="mobile_2">
                        ...
                        <div class="social-links">
                            <a href="<?php echo $home_page_data['footer_twitter']; ?>" target="_blank" class="twitter"><i class="bx bxl-twitter"></i></a>
                            <a href="<?php echo $home_page_data['footer_facebook']; ?>" target="_blank" class="facebook"><i class="bx bxl-facebook"></i></a>
                            <a href="<?php echo $home_page_data['footer_instagram']; ?>" target="_blank" class="instagram"><i class="bx bxl-instagram"></i></a>
                            <a href="<?php echo $home_page_data['footer_skype']; ?>" target="_blank" class="google-plus"><i class="bx bxl-skype"></i></a>
                            <a href="<?php echo $home_page_data['footer_linkedin']; ?>" target="_blank" class="linkedin"><i class="bx bxl-linkedin"></i></a>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\mockmyinterview\resources\views/layouts/web/footer.blade.php ENDPATH**/ ?>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="mt_contact" class="form-control" value="<?php echo e(isset($page_data['mt_contact'])?$page_data['mt_contact']:''); ?>" placeholder="Enter meta title">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Meta Keyword </label>
							<div class="col-sm-9">
								<textarea class="form-control" name="mk_contact" style="height:60px;" placeholder="Enter meta keyword"><?php echo e(isset($page_data['mk_contact'])?$page_data['mk_contact']:''); ?></textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Meta Description </label>
							<div class="col-sm-9">
								<textarea class="form-control" name="md_contact" style="height:60px;" placeholder="Enter meta description"><?php echo e(isset($page_data['md_contact'])?$page_data['md_contact']:''); ?></textarea>
							</div>
						</div>
						<div class="form-group">

...
<section class="content">
	<div class="row">
		<div class="col-md-12"> 
			<form action="<?php echo e(route('slider.store')); ?>" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				<?php echo csrf_field(); ?>
						...
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									...
									<span style="color: red"><?php echo e($errors->first('left_sec_title')); ?></span>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									...
									<span style="color: red"><?php echo e($errors->first('left_sec_sub_description')); ?></span>
								</div>
							</div>
							<div class="form-group">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mockmyinterview\resources\views/admin/slider/create.blade.php ENDPATH**/ ?>